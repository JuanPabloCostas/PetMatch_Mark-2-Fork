...
const RightSidebar = () => {
  return (
    <section className='sticky right-0 top-0 z-20 flex h-screen w-80 flex-col justify-start overflow-auto border-l border-gray-200 bg-white px-6 py-4 shadow-lg max-xl:hidden'>
