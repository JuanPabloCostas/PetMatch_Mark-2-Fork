      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          {pricingPlans.map((plan, index) => (
            <div
              key={index}
              className="flex h-full flex-col justify-between rounded-lg px-6 py-8 md:p-8 shadow-medium"
            >
              <div>
              ...
              <div>
                <Button className="border-1 border-primary-500 bg-transparent hover:bg-primary-500 hover:text-white w-full">
                  Suscribirme
                </Button>
              </div>
            </div>
